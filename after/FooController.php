...
{
    public static function registerWithApp($app) 
    {
     ...
     */
    private function create(array $data) : \Slim\Http\Response
    {
     ...
     * @return \Slim\Http\Response
     */
    private function get(string $uuid) : \Slim\Http\Response
    {
     ...
     * @return \Slim\Http\Response
     */
    private function getAll() : \Slim\Http\Response
    {
     ...
     * @return \Slim\Http\Response
     */
    private function update(string $uuid, array $data) : \Slim\Http\Response
    {
        $randomNumber = rand(0, 1);
        $successful = ($randomNumber === 0);
